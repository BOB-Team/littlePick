					...
					<div class="categories_post">
						...
						<div class="blog_info">
							<a href="community_board_view.do?content_num=${board1.content_num}">
								...
								src="resources/upload/user/${board.user_image}" width="20px" href="#"></a><a href="#">${board1.user_nickname}</a><br>
					...
					<div class="categories_post">
						...
						<div class="blog_info">
							<a href="community_board_view.do?content_num=${board2.content_num}">
								...
								src="resources/upload/user/${board.user_image}" width="20px" href="#"></a><a href="#">${board2.user_nickname}</a><br>
					...
					<div class="categories_post">
						...
						<div class="blog_info">
							<a href="community_board_view.do?content_num=${board3.content_num}">
								...
								src="resources/upload/user/${board.user_image}" width="20px" href="#"></a><a href="#">${board3.user_nickname}</a><br>
						...
						<div class="col-md-2">
							<div class="my_blog_info">
								...
								<ul class="blog_meta list">
									<li><a href="#">
									<img src="resources/upload/user/${board.user_image}" width="20px">${board4.user_nickname}</a></li>

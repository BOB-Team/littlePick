...
<div class="board-search">
 ...
 <hr>
	...
	<section class="commu_area">
		...
		<form action="community_board1.do" method="post">
					...
					<div class="categories_post">
						...
						<div class="blog_info">
							<a href="community_board_view.do?content_num=${board.content_num}">
								...
								src="resources/upload/user/${board.user_image}" width="20px" href="mypage_userpage.do?user_num=${board.user_num}"></a><a href="mypage_userpage.do?user_num=${board.user_num}">${board.user_nickname}</a><br>

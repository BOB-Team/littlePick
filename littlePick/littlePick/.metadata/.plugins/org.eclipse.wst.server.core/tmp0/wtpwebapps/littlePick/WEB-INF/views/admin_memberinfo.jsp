...
<!-- ----------------------------------------------------------------------------------------------------------------- -->				
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						<h4 class="text-blue h4">회원 관리 모드</h4>
					</div>	
					...
					<input type="button" value="삭제" onClick="location.href='memberDelete.do?user_email=${member.user_email}'">
					...
					<div class="pb-20">
						<table class="checkbox-datatable table nowrap">
							<thead>
									...
									<tr><th>회원번호</th> <td><input type="text" name="user_num" value="${member.user_num}"/></td></tr>
									<tr><th>이름</th> <td><input type="text" name="user_name" value="${member.user_name}"/></td></tr>
									<tr><th>이메일</th> <td><input type="text" name="user_email" value="${member.user_email}"/></td></tr>
									<tr><th>비밀번호</th> <td><input type="text" name="user_password" value="${member.user_password}"/></td></tr>
									<tr><th>닉네임</th> <td><input type="text" name="user_nickname" value="${member.user_nickname}"/></td></tr>
									<tr><th>핸드폰 번호</th> <td><input type="text" name="user_phone" value="${member.user_phone}"/></td></tr>
									<tr><th>주소</th> <td><input type="text" name="user_address" value="${member.user_address}"/></td></tr>
									<tr><th>성별</th> <td><input type="text" name="user_gender" value="${member.user_gender}"/></td></tr>
									<tr><th>생일</th> <td><input type="text" name="user_birth" value="${member.user_birth}"/></td></tr>
									<tr><th>가입일</th> <td><input type="text" name="user_regdate" value="${member.user_regdate}"/></td></tr>
									<tr><th>포인트</th> <td><input type="text" name="user_point" value="${member.user_point}"/></td></tr>

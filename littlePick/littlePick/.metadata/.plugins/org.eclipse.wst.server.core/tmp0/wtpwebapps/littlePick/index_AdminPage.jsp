...
<head>
	...
	<meta charset="utf-8">
	<title>littlePick 관리자 페이지</title>
...
<body>
	<div class="pre-loader">
		<div class="pre-loader-box">
			<div class="loader-logo"><img src="resources/admin/resources/images/LittlePickLogo.png" alt=""></div>
					...
					<div class="dropdown-menu dropdown-menu-right">
						<div class="notification-list mx-h-350 customscroll">
							<ul>
								<li>
									<a href="#">
										<img src="resources/admin/resources/vendors/images/img.jpg" alt="">
										<h3>John Doe</h3>
								...
								<li>
									<a href="#">
										<img src="resources/admin/resources/vendors/images/photo1.jpg" alt="">
										<h3>Lea R. Frith</h3>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed...</p>
									</a>
								</li>
								<li>
									<a href="#">
										<img src="resources/admin/resources/vendors/images/photo2.jpg" alt="">
								...
								<li>
									<a href="#">
										<img src="resources/admin/resources/vendors/images/photo3.jpg" alt="">
										<h3>John Doe</h3>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed...</p>
									</a>
								</li>
								<li>
									<a href="#">
										<img src="resources/admin/resources/vendors/images/photo4.jpg" alt="">
	...
	<div class="left-side-bar">
		...
		<li class="dropdown">
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							<li><a href="admin_qnaanswer.do">문의사항</a></li>
						</ul>
					</li>
...
<!--  			<div class="card-box mb-30">
				...
				<table class="data-table table nowrap">
					...
					<tbody>
						<tr>
							<td class="table-plus">
								<img src="resources/admin/resources/images/product-1.jpg" width="70" height="70" alt="">
							</td>
							<td>
						...
						<tr>
							<td class="table-plus">
								<img src="resources/admin/resources/images/product-2.jpg" width="70" height="70" alt="">
							</td>
							<td>
						...
						<tr>
							<td class="table-plus">
								<img src="resources/admin/resources/images/product-3.jpg" width="70" height="70" alt="">
							</td>
							<td>
						...
						<tr>
							<td class="table-plus">
								<img src="resources/admin/resources/images/product-4.jpg" width="70" height="70" alt="">
							</td>
							<td>
						...
						<tr>
							<td class="table-plus">
								<img src="resources/admin/resources/images/product-5.jpg" width="70" height="70" alt="">
							</td>
							<td>
	...
	<script src="resources/admin/resources/plugins/apexcharts/apexcharts.min.js"></script>
	...
	<script src="resources/admin/resources/vendors/scripts/dashboard.js"></script>
</body>
</html>
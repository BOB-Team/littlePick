...
<!-- ----------------------------------------------------------------------------------------------------------------- -->				
				...
				<div class="card-box mb-30">
					...
					<div class="pd-20">
						<h4 class="text-blue h4">상품 관리 모드</h4>
					</div>
					...
					<div class="pb-20">
						...
						<table class="checkbox-datatable table nowrap">
									...
									<tr><th>상품이름</th> <td><input type="text" name="product_name" value=""/></td></tr>
									<tr><th>상품정보</th> <td><input type="text" name="product_info" value=""/></td></tr>
									<tr><th>상품이미지</th> <td><input type="file" name="file" multiple="multiple"/></td></tr>
									<tr><th>판매가격</th> <td><input type="text" name="sale_price" value=""/></td></tr>
									<tr><th>현재가격</th> <td><input type="text" name="now_price" value=""/></td></tr>
									<tr><th>입고가</th> <td><input type="text" name="in_price" value=""/></td></tr>
									<tr><th>재고</th> <td><input type="text" name="stock" value=""/></td></tr>
									<tr><th>조회수</th> <td><input type="text" name="product_view" value=""/></td></tr>
									<tr><th>배송번호</th> <td><input type="text" name="delivery_num" value=""/></td></tr>
									<tr><th>소포장</th><td><input type="text" name="smallpack" value=""/></td></tr>
									<tr><th>상품태그</th><td><input type="text" name="product_tag" value=""/></td></tr>

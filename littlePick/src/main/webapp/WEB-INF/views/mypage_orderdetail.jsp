						...
						<div class="col-md-12">
							<div class="blog_post">
								<div class="blog_details">
									<a>주문번호: ${ord.order_num}</a>
									<a>주문날짜: ${ord.order_date}</a>
									<a>주문금액: ${ord.total_account}</a>
									<a>결제:${ord.order_state}</a>
									
									
									<c:forEach items="${orderList}" var="order">
									<hr>
								<div class="mypage-orderdetail-detail">
									<div class="mypage-orderdetail-img">
										<a href="product.do?product_num=${order.product_num}">
										<img src="resources/img/product/${order.product_image}" width="75px" height="75px">
										</a> 
									</div>

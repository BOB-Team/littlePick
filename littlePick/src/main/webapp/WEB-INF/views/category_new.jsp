...
<body>
	...
	<main class="site-main">
		...
		<section>
			<div id="banner_wrap">
					<a href="#"><img alt="" src="resources/img/banner/banner5.png" width="1110px"></a>
			</div>
		</section>
		<section class="section-margin calc-60px">
			<div class="container">
				...
				<div class="row">
					<c:forEach items="${mainList2 }" var="p2" begin="0" end="15" step="1">
						...
						<div class="card text-center card-product">
							...
							<div class="card-body">
								...
								<c:choose>
				                   ...
				                   <c:when test="${p2.delivery_num==2}">샛별 배송</c:when>
